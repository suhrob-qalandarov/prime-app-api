...
public class AdminInventoryTransactionController {
    ...
    public ResponseEntity<InventoryTransactionResponse> createTransaction(@Valid @RequestBody InventoryTransactionRequest request) {
    ...
    public ResponseEntity<Page<InventoryTransactionResponse>> getAllTransactions(
        ...
        Page<InventoryTransactionResponse> response = inventoryTransactionService.getAllTransactions(
                type, reason, productId, customerId, startDate, endDate, pageable
        );
        return ResponseEntity.ok(response);
    }
}
