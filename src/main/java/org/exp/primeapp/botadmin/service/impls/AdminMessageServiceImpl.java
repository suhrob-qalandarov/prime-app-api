...
public class AdminMessageServiceImpl implements AdminMessageService {
    ...
    public Integer sendProductColorPrompt(Long chatId) {
        ...
        InlineKeyboardMarkup withBack = ((AdminButtonServiceImpl) buttonService).addBackButton(colorButtons,
                "WAITING_BRAND");
    ...
    public void sendImageSavedSuccess(Long chatId, int currentCount, int remaining) {
        ...
        // Create buttons: Previous step (back to WAITING_MAIN_IMAGE) and Next step
        // (skip to WAITING_SPOTLIGHT_NAME)
    ...
    @Override
    public void sendProductConfirmation(Long chatId, String caption,
            org.exp.primeapp.botadmin.models.ProductCreationState state) {
        ...
        if (state != null && state.getAttachmentUrls() != null && !state.getAttachmentUrls().isEmpty()) {
                ...
                try {
                    ...
                    if (attachment != null && attachment.getFilePath() != null) {
                        ...
                        if (photoFile.exists() && photoFile.isFile()) {
                            ...
                            if (i == 0) {
                                mediaList
                                        .add(new InputMediaPhoto(photoFile).caption(caption).parseMode(ParseMode.HTML));
                            } else {
            ...
            if (!mediaList.isEmpty()) {
                ...
                if (mediaList.size() <= 10) {
                    ...
                    telegramBot.execute(
                            new SendMediaGroup(chatId, mediaList.subList(0, 10).toArray(new InputMediaPhoto[0])));
    ...
    @Override
    public void sendProductSizeQuantityPrompt(Long chatId,
            org.exp.primeapp.botadmin.models.ProductCreationState state) {
    ...
    @Override
    public void sendUsersStatistics(Long chatId, long totalCount, long adminCount, long superAdminCount,
    ...
    public void sendUserInfo(Long chatId, User user, boolean canSetAdmin, boolean canSetSuperAdmin) {
        try {
            ...
            message.append("🔖 Username: ").append(user.getTgUsername() != null ? "@" + user.getTgUsername() : "N/A")
                    .append("\n");
